...
![](p8105_hw3_ss6692_files/figure-gfm/unnamed-chunk-1-1.png)<!-- --> As
shown by all three panels of the plot, total activity tends to decrease
as age increases, regardless of education level. Both men and women with
less than a high school education have the highest total activity level
across groups around age 20. \### Finally, we are making a plot to
visualize 24-hr activity time courses by education and sex.
...
![](p8105_hw3_ss6692_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
